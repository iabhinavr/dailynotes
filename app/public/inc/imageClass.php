...
class Image {
    ...
    private function write_image($regenerated_image, $thumbnail) {
        ...
        if( !is_dir("../uploads/large/$this->folder_path") ) {
            mkdir("../uploads/large/$this->folder_path", 0777, true);
        }
        ...
        $upload_large = $regenerated_image->writeImage("../uploads/large/$this->folder_path/" . $this->file_name);

        $upload_thumbnail = $thumbnail->writeImage("../uploads/thumbnails/$this->folder_path/" . $this->file_name);

        if($upload_large && $upload_thumbnail) {
    ...
    private function validate_image() {
        ...
        if( file_exists("../uploads/large/$this->upload_year/$this->upload_month/" . $this->file_name)) {
    ...
    private function regenerate_image() {
        ...
        if ($image) {
            ...
            $get_saved_width = $this->settings->get_option('large_size');
    ...
    public function delete_image($id) {
        ...
        unlink("../uploads/large/$image_path");
