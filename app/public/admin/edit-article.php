...
if(isset($_POST['get-article-content'])) {
    $id = (int)$_POST['id'];
        ...
        <div class="modal-dialog modal-fullscreen" id="image-library">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="set-selected-image" class="btn btn-primary" data-bs-dismiss="modal" data-image-id="" data-thumbnail-src="" data-full-src="" data-image-list="" data-action="">Set Selected Image</button>
                </div>
            </div>
